...
import availableFeatures from '../data/consultancy';

const ConsultancyTraining = ( { navigateTo }) =>{
  ...
  const onSaveStep = () =>{
    ...
    quote["TrainingFeatures"] = features;
    setQuote(quote);
  }
  ...
  return (
      ...
      <div class="bg-gray-100 p-8">
          ...
          <TypeWriterText text="Perfect, if you're offer Consultancy or Training, would any of the following be useful?" onTextCompleted={setIsLoaded} />  
          </p>
